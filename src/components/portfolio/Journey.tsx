...
const milestones = [
  ...
  { year: "Jun 2026", title: "Internshala Student Partner", text: "Selected as an Internshala Student Partner (ISP) — representing Internshala on campus and helping peers explore internships." },
